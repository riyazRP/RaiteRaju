...
namespace RaiteRaju.BusinessLayer
{
    public class InformationBusinessLayer : InformationBusinessLayerInterface
    {
        ...
        public AdDetailsEntity SPRRGetAdDisplayDetails(Int32 AdId)
        {
            return new DAL.InformationDAL().SPRRGetAdDisplayDetails(AdId);
        }
        ...
        public List<UserDetailsEntity> FetchUserDetailsForAdminPage(Int32 PAGENUMBER, out int TotalPageNumber)
        {
            return new DAL.InformationDAL().FetchUserDetailsForAdminPage(PAGENUMBER, out TotalPageNumber);
        }
